        ...
        <Link to={`/event/lesson/${props.slug}`} className='group'>
            ...
            <div className={classNames('rounded border border-gray-500 p-4 mt-2 group-hover:border-green-500', {'bg-green-500': isActiveLesson,})}>
                ...
                <header className="flex items-center justify-between">
                    ...
                    <span className={classNames('text-xs rounded px-2 py-[0.125rem] text-white border ', {'border-white': isActiveLesson, 'border-green-300': !isActiveLesson})}>{props.type === 'live' ? 'AO VIVO' : 'AULA PRÁTICA'}</span>
